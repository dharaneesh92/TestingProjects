...
public class BaseTest {
	...
	public void beforeTestMethod() {
		...
		extent.setSystemInfo("Report Generated By", "Dharaneesh");
		SparkReporter.config().setDocumentTitle(LocalDate.now()+" TestReports");
		SparkReporter.config().setReportName("Automation Test Results");
	}
	
	@BeforeMethod
	@Parameters("browser")
	public void initiatebrowser(String browser, Method testMethod) {
	...
	public void afterMethod(ITestResult result) {
		if(result.getStatus()==ITestResult.FAILURE) {
			...
			logger.log(Status.SKIP,MarkupHelper.createLabel(result.getName()+" - Testcase Skipped ", ExtentColor.YELLOW));
		}
